...
<body>
    ...
    <h3>ORION OFFERS YOU WITH THESE PACKAGES</h3><br><br>
    
<form  class="input" method="post"  action="orionrecharge.php">
    ...
    <label for="packages"name="s_price">Packages:</label>
              <select name="s_price" class="network">
               ...
               <option  value="2999">2999/-</option><br><br><br>
...
<?php
   ...
   {    
    ...
    $s_name=mysqli_real_escape_string($conn, $_POST['Orion']);
