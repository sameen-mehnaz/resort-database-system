...
<title> Omega Package </title>
</head>
<body>
    <div class="form">
    <h3>OMEGA OFFERS YOU WITH THESE PACKAGES</h3><br><br>
    
<form  class="input" method="post"  action="omegarecharge.php">
    ...
    <label for="packages"name="s_price">Packages:</label>
              <select name="s_price" class="network">
               ...
               <option  value="399">399/-</option><br><br><br>
...
<?php
   ...
   {    
    ...
    $s_name=mysqli_real_escape_string($conn, $_POST['Omega']);
