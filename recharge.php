...
<body>
    <div class="form">
    <h1>VacayGo OFFERS YOU WITH THESE PACKAGES</h1>
...
<form  class="input" method="post"  action="recharge.php">
    ...
    <p style="font-size: 20px;">Please Select Your DREAM RESORT And Package </p><br>
  ...
  Service Name: <select name="Name" id="id_parent" data-child-id='id_child' class='dependent-selects__parent'>
    ...
    <button class="are" type="submit" name="submit">BOOK NOW</button>
</form>
</div>
<?php
