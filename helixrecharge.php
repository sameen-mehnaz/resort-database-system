...
<title> Helix Package </title>
</head>
<body>
    <div class="form">
    <h3>HELIX OFFERS YOU WITH THESE PACKAGES</h3><br><br>
    
<form  class="input" method="post"  action="helixrecharge.php">
    ...
    <label for="packages"name="s_price">Packages:</label>
              <select name="s_price" class="network">
               ...
               <option  value="1000">1000/-</option><br><br><br>
