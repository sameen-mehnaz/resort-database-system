                ...
                <div class="para">
                        <div class="recharge">   
                            <div class="col2">
                                    ...
                                    <h3>Click on BOOK NOW to Avail your package</h3>
                                    <br>
                                    
                                    <a href="recharge.php" class="area">BOOK NOW</a><br><br>
                            </div>
                        </div>
                     
                <p style="color: #fff; font-size: 50px; text-align: center;font-family: Segoe Script; margin-top: 0px;">Paid Activities</p>
                    <div class="container">
                    
                            <div class="row">
                                <div class="col1">
                                    <img src="paraglide.jpg" width="150px">
                                    <h3>Paragliding</h3>
                                    
                                    <h4>Soar over landscapes for a unique perspective.</h4><br><br>
                                    <h3>₹5,990</h3>
                                </div>
                                <div class="col1">
                                    <img src="scuba.png" width="150px">
                                    <h3> Scuba Diving</h3>
                            
                                    <h4>Explore vibrant coral reefs and marine life.</h4><br> 
                                    <h3>₹9,999</h3x>
                                </div>
                                <div class="col1">
                                    <img src="spa.jpg" width="150px" >
                                    <p></p>
                                    <h3>Spa Treatments</h3>
                                    <h4>Enjoy massages, facials, and body treatments.</h4><br> <br> 
                                    <h3>₹4,990</h3>
                                </div>
                                <div class="col1">
                                    <img src="jet.webp" width="150px">
                                    <p></p>
                                    <h3>Jet Skiing</h3>
                                    <h4>Experience the thrill of speed on the open water.</h4><br> 
                                    <h3>₹3,999</h3>
                                </div>
                ...
                <div class="ser">
                    <h1 style="font-family: Segoe Script;"> Stay Updated With Some News </h1>
                        <div class="box">
                            ...
                            <div class="content">
                                <h3>Latest News</h3>
                                <p>Horseback Riding: Ride through trails, beaches, or countryside. </p>
                        ...
                        <div>
                            <div class="box">
                                ...
                                <div class="content">
                                    <h3>Lastest News</h3>
                                    <p> Water Parks: Fun slides and wave pools for families.
                                    </p>
                        ...
                        <div>
                            <div class="box">
                                ...
                                <div class="content">
                                    <h3>Latest News</h3>
                                    <p>Board Games and Movie Nights: Relax with classic games or a film.
                                    </p>
                                    <a href="https://telecom.economictimes.indiatimes.
