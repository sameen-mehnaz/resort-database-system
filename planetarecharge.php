...
<title>Planeta Package </title>
</head>
<body>
    <div class="form">
    <h3>PLANETA OFFERS YOU WITH THESE PACKAGES</h3><br><br>
    
<form  class="input" method="post"  action="planetarecharge.php">
    ...
    <label for="packages"name="s_price">Packages:</label>
              <select name="s_price" class="network">
               ...
               <option  value="799">799/-</option><br><br><br>
...
<?php
   ...
   {    
    ...
    $s_name=mysqli_real_escape_string($conn, $_POST['Planeta']);
