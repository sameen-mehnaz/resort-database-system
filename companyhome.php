...
<?php
    ...
    $result="SELECT * 
    FROM hod , department, company 
    WHERE hod.h_id=department.h_id AND department.co_name=company.co_name AND company.co_name='$username'";
   // echo $result;
    ...
    <div class="parnt">
        <div class="sb">
                ...
                <ul>
                    ...
                    <li><a href="viewfeedback.php"><i class="fas fa-tasks"></i>REVIEW</a></li>
                ...
                <center><table>
                    ...
                    <div class="para">
                        <div class="bx">
                            ...
                            <a href="s2.php" class="area">Delete</a>
                        </div>
                      <div class="bx">
                            <div class="icon">02</div><br>
                            <h4>APPOINT HOD</h4>
                            <p></p>
                            <a href="updatehod.php" class="are">Update</a>
