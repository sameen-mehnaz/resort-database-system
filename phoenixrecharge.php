...
<style>
    *{
    ...
    body{
        background-image: url(imaaa.png);
    }
    .form{
...
<body >
    <div class="form">
    <h1>PHOENIX OFFERS YOU WITH THESE PACKAGES</h1>
    
    <form  class="input" method="post"  action="phoenixrecharge.php">
    ...
    <input type="radio" name="package" value="499" >
    <label for="package1" style="color: #777";>499/-</label><br><br>
    <input type="radio" name="package" value="649">
    <label for="package2" style="color: #777";>649/-</label><br>
